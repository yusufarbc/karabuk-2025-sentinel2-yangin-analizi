...
\begin{table}[H]
    ...
    \textbf{Safranbolu - Çıldıkısık \& Kayı} & 22 Tem & $\approx 55$ ha & Örtü Yangını (Orta dNBR) \\
...
\clearpage
\subsection{3. Ovacık - Kışla Köyü Yangını}
...
\clearpage
\subsection{4. Safranbolu - Toprakcuma Bölgesi}
...
\clearpage
\subsection{5. Eflani - Araç (Kastamonu) Sınır Hattı}
